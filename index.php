...
function genererHeader(string $title, array $styles = []): string
{
    ...
    <head>
        <meta charset='UTF-8'>
        <link rel="icon" href="/www/arnoux23u/mywishlist/assets/img/icons/favicon.ico">
        ...
        <meta property="og:image" content="https://mywishlist.garnx.fr/www/arnoux23u/mywishlist/assets/img/logos/2.png" />
        ...
        <link href="/www/arnoux23u/mywishlist/assets/css/forall.css" rel="stylesheet">
        <link href="/www/arnoux23u/mywishlist/assets/css/navbar.css" rel="stylesheet">
        <title>$title</title>
    EOD;
    foreach ($styles as $style)
        $html .= "\n\t<link rel='stylesheet' href='/www/arnoux23u/mywishlist/assets/css/$style'>";
    $html .= "\n</head>\n<body>\n";
