...
class UserView extends View
{
    ...
    private function resetPassword(): string
    {
        ...
        $html = <<<HTML
            ...
            <script src="/www/arnoux23u/mywishlist/assets/js/password-validator.js"></script>
            <script src="/www/arnoux23u/mywishlist/assets/js/password-viewer.js"></script>
        </body>
        </html>
        HTML;
    ...
    private function register(): string
    {
        ...
        $html = <<<HTML
            ...
            <script src="/www/arnoux23u/mywishlist/assets/js/password-validator.js"></script>
            <script src="/www/arnoux23u/mywishlist/assets/js/password-viewer.js"></script>
            <script src="/www/arnoux23u/mywishlist/assets/js/avatar-register.js"></script>
        </body>
        </html>
        HTML;
    ...
    protected function show(): string
    {
        ...
        $phtmlVars = array(
            ...
            "avatar_src" => (!empty($user->avatar) && file_exists($this->container['users_img_dir'] . DIRECTORY_SEPARATOR . "$user->avatar")) ? "/www/arnoux23u/mywishlist/assets/img/avatars/$user->avatar" : "https://www.gravatar.com/avatar/" . md5(strtolower(trim($user->mail))) . "?size=120",
    ...
    private function manage2FA(): string
    {
        ...
        return genererHeader("{$this->container->lang['user_2fa_manage']} - MyWishList", ["profile.css"]) . <<<HTML
            <div class="main-content">
                <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
                <div class="container-fluid">
                    <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="$route_main"><img alt="logo" class="icon" src="/www/arnoux23u/mywishlist/assets/img/logos/6.png" />MyWishList</a>
                </div>
                </nav>
                <div class="header pb-8 pt-5 pt-lg-8 d-flex align-items-center" style="min-height: 300px;  background-size: cover; background-position: center top;">
                    <span class="mask bg-gradient-default opacity-8"></span>
    ...
    private function sidebar(): string
    {
        ...
        $phtmlVars = array(
            ...
            'flag_img' => "<img class='selected' alt='" . strtolower($_SESSION["lang"]) . "-flag' src='/www/arnoux23u/mywishlist/assets/img/flags/flag-" . strtolower($_SESSION["lang"]) . ".png'>",
    ...
    {
        $avatar = (!empty($this->user->avatar) && file_exists($this->container['users_img_dir'] . DIRECTORY_SEPARATOR . $this->user->avatar)) ? "/www/arnoux23u/mywishlist/assets/img/avatars/{$this->user->avatar}" : "https://www.gravatar.com/avatar/" . md5(strtolower(trim($this->user->mail))) . "?size=120";
