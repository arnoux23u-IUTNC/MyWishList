...
class ItemView
{
    ...
    private function requestAuth(){
        ...
        return genererHeader("{$this->container->lang['item_edition']} - {$this->container->lang['auth']}", ["list.css"]). <<<EOD
            <h2>{$this->container->lang['item_editing']}</h2>
            <div>
                <form class='form_container' method="post" action="$from">
                    ...
                    <button type="submit" name="sendBtn">{$this->container->lang['validate']}</button>
                </form>
            <div>
        </body>
        </html>
    ...
    private function confirmDelete(){
        ...
        return genererHeader("{$this->container->lang['item_delete']} $i->id", ["list.css"]). <<<EOD
            <h2>{$this->container->lang['item_delete']} $i->id</h2>
            <div>
                <p class="warning">{$this->container->lang['item_delete_confirm']} $i->id ?</p>
    ...
    private function edit(){
        ...
        return genererHeader("Item $i->id | {$this->container->lang['editing']}", ["list.css"]). <<<EOD
            <h2>{$this->container->lang['item_edit']} $i->id</h2>
            <div>
